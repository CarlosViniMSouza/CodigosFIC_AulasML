...
EntroGripe = ((-1*quantGripeSim/6) * math.log(quantGripeSim/6, 2) -
              (quantGripeNao/6) * math.log(quantGripeNao/6, 2))
print("O resultado de Entropia(GRIPE) eh: ", EntroGripe)

EntroCala = ((-1*quantCalaSim/6) * math.log(quantCalaSim/6, 2) -
             (quantCalaNao/6) * math.log(quantCalaNao/6, 2))
print("O resultado de Entropia(Calafrios) eh: ", EntroCala)

EntroCefa = ((-1*quantCefaSim/6) * math.log(quantCefaSim/6, 2) -
             (quantCefaNao/6) * math.log(quantCefaNao/6, 2))
print("O resultado de Entropia(Cefaleia) eh: ", EntroCefa)

EntroCori = ((-1*quantCoriSim/6) * math.log(quantCoriSim/6, 2) -
             (quantCoriNao/6) * math.log(quantCoriNao/6, 2))
print("O resultado de Entropia(Coriza) eh: ", EntroCori)

EntroFebre = ((-1*quantFebreSim/6) * math.log(quantFebreSim/6, 2) -
              (quantFebreNao/6) * math.log(quantFebreNao/6, 2))
print("O resultado de Entropia(Febre) eh: ", EntroFebre)

print("\nO ganho da informacao em cada atributo eh: \n")

print("Na variavel (Calafrios): ", (EntroGripe - EntroCala))

print("Na variavel (Cefaleia): ", (EntroGripe - EntroCefa))

print("Na variavel (Coriza): ", (EntroGripe - EntroCori))

print("Na variavel (Febre): ", (EntroGripe - EntroFebre))
